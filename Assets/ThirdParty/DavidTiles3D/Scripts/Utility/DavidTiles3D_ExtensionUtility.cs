...
{
    public static class DavidTiles3D_ExtensionUtility
    {
        ...
        public static void VerifyInstance(this InternalNode node)
        {
            ...
            else
            {
                ...
                if (tile == null)
                {
                    Debug.LogError("DavidTiles3D: Internal node  is missing tile");
                    return;
                }
        ...
        public static void UpdateInstance(this InternalNode node)
        {
            ...
            if (tile == null)
            {
                ...
                if (tile == null)
                {
                    ...
                    Debug.LogError($"DavidTiles3D: Internal node is can't retrieve tile {node.TileName} {node.TileID}");
                    return;
                }
            }
        ...
        public static void Randomize(this InternalNode node, bool dontAllowSame = true)
        {
            ...
            {
                Debug.Log("DavidTiles3D: No randomization possible");
            }
        }
        ...
        public static bool TryRandomize(this InternalNode node, out GameObject random, bool dontAllowSame = true)
        {
            ...
            DavidTiles3D_Rule rule = tile.GetRule(neighbors, out addedRotation);
        ...
        public static void CreateInstance(this InternalNode node, GameObject prefab)
        {
            ...
            var newBlock = newInstance.GetComponent<DavidTiles3D_BlockBehaviour>();
        ...
        public static bool IsEqual(this DavidTiles3D_Tile tile, DavidTiles3D_Tile compare)
        {
            if (tile == compare)
                return true;
        ...
        public static DavidTiles3D_Anchor EnsureAnchor(this DavidTiles3D_TileLayer layer, string group, string tileName, int tileID)
        {
            if (!layer.Anchors.ContainsKey(tileID))
            {
                ...
                var anchor = anchorObject.AddComponent<DavidTiles3D_Anchor>();
        ...
        public static List<Vector3Int> GetNeighborsPosition(this DavidTiles3D_TileLayer layer, Vector3Int internalPosition)
        {
        ...
        public static bool[] GetNeighborsBoolSelfSpace(this DavidTiles3D_TileLayer layer, Vector3Int internalPosition, Quaternion localRotation)
        {
