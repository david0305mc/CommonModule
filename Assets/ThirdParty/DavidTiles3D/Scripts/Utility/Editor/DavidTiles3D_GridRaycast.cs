...
{
    public static class DavidTiles3D_GridRaycast
    {
        ...
        public static bool GridRayCast(DavidTiles3D_TileLayer layer, Vector3 start, Vector3 end, out Vector3Int internalHit, out Vector3Int hitNormal, out List<Vector3> visits)
        {
