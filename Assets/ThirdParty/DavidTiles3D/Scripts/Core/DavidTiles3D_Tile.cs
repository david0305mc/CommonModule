...
namespace DavidTiles3D
{
    ...
    [System.Serializable]
    public class DavidTiles3D_Rule
    {
        ...
        //The reason for this is simply because the Randomized Objects list was added in a later DavidTiles3D update.
        ...
        public DavidTiles3D_Rule(DavidTiles3D_Rule copy)
        {
            _ruleID = System.Guid.NewGuid().GetHashCode();
    ...
    [System.Serializable]
    public class DavidTiles3D_Tile
    {
        ...
        public List<DavidTiles3D_Rule> Rules = new List<DavidTiles3D_Rule>();
        ...
        [NonSerialized] private DavidTiles3D_TileGroup cachedGroup;
        public DavidTiles3D_TileGroup GetGroup()
        {
            if (cachedGroup != null)
            {
            ...
            List<DavidTiles3D_TileGroup> groups = DavidTiles3D_Utility.LoadTileGroups();
        ...
        public DavidTiles3D_Tile(string displayName)
        {
            _name = displayName;
        }
        public DavidTiles3D_Tile(DavidTiles3D_Tile copy)
        {
            ...
            {
                Rules.Add(new DavidTiles3D_Rule(rule));
            }
        }
...
#if UNITY_EDITOR
        /// <summary>
        /// same method as in DavidTiles3D_Rule, but for the Default Object
        /// </summary>
        ...
        public DavidTiles3D_Rule GetRule(bool[] neighbors, out int[] addedRotation)
        {
        ...
        private bool DoesRulePass(DavidTiles3D_Rule rule, bool[] neighbors, out int[] rotation)
        {
        ...
        public void RenderTileGUI(out bool dirty, UnityEngine.Object context)
        {
            ...
            if (newName != Name)
            {
                ...
                int increase = 1;
                while (DavidTiles3D_Utility.DoesTileExist(-1, newName, _group))
                {
                    newName += $"({increase++})";
                }
            ...
            foreach (var rule in Rules.ToArray())
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    if (selection > -1)
                    {
                        ...
                        if (selection != 13)
                        {
                            var tempSelection = DavidTiles3D_EnumUtility.Next(rule.Relations[selection]);
            ...
            if (GUILayout.Button("+"))
            {
                ...
                Rules.Add(new DavidTiles3D_Rule());
            }
            if (GUILayout.Button("-"))
            {
                if (Rules.Count > 0)
            ...
            {
                dirty = true;
                DavidTiles3D_Utility.ClearCache(TileID);
            }
        }
