...
namespace DavidTiles3D
{
    ...
    [CustomEditor(typeof(DavidTiles3D_BlockBehaviour), true)]
    public class DavidTiles3D_BlockBehaviourInspector : Editor
    {
        private DavidTiles3D_BlockBehaviour _baseBlock;
        bool _canRandomize;
        bool _debug;
        public virtual void OnEnable()
        {
            _baseBlock = (DavidTiles3D_BlockBehaviour)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (tile == null)
            {
                EditorGUILayout.LabelField("<color=red> LINK TO TILE IS MISSING </color>", DavidTiles3D_Utility.RichStyle);
                EditorGUILayout.LabelField("This might be due to migration to DavidTiles3D version 1.3 or because you have deleted TileGroups/Tiles");
                ...
                EditorGUILayout.LabelField("If you would like to reconnect, you can manually update the TileGroup's name and the tile's name for this block here once, and DavidTiles3D automatically links things up again!");
                ...
                {
                    DavidTiles3D_Utility.RepairBlocks(_baseBlock, _baseBlock.Anchor.GetBlocks(), updateGroup, updateTile);
                }
