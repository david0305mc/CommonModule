...
{
    public class DavidTiles3D_BlockBehaviour : MonoBehaviour
    {
        ...
        private DavidTiles3D_Anchor _anchor;
        ...
        public DavidTiles3D_Grid Grid
        {
            get
            {
                if (this == null)
                    return null;
                if (_grid == null)
                    _grid = transform.GetComponentInParent<DavidTiles3D_Grid>();
                return _grid;
            }
        }
        public DavidTiles3D_Anchor Anchor
        {
            get
            {
                if (this == null)
                    return null;
                if (_anchor == null)
                    _anchor = transform.GetComponentInParent<DavidTiles3D_Anchor>();
                return _anchor;
            }
        }
        ...
        public void UpdateTileInfo(DavidTiles3D_Tile tile)
        {
            _group = tile.Group;
            _tileName = tile.Name;
            _tileID = tile.TileID;
        ...
        public InternalNode GetInternalNode()
        {
            if (Anchor != null)
            {
                DavidTiles3D_TileLayer layer = Anchor.Layer;
                if (layer != null)
                {
