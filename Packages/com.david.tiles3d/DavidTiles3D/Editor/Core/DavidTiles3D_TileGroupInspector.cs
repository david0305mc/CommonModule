...
{
    [CustomEditor(typeof(DavidTiles3D_TileGroup))]
    public class DavidTiles3D_TileGroupInspector : Editor
    {
        DavidTiles3D_TileGroup _group;

        public static DavidTiles3D_Tile CopyBuffer;
        private void OnEnable()
        {
            _group = (DavidTiles3D_TileGroup)target;
        }
        public override void OnInspectorGUI()
        {
            ...
            foreach (var tile in _group.Tiles.ToArray())
            {
                ...
                if (GUILayout.Button("Copy"))
                {
                    ...
                    DavidTiles3D_TileGroupInspector.CopyBuffer = tile;
                }
            ...
            if (GUILayout.Button("Add new tile"))
            {
                ...
                _group.Tiles.Add(new DavidTiles3D_Tile("New Tile"));
            }
            ...
            if (DavidTiles3D_TileGroupInspector.CopyBuffer != null)
            {
