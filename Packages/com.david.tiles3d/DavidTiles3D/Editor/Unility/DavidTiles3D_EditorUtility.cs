...
{
    public static class DavidTiles3D_EditorUtility
    {
   
        public static HashSet<Vector3Int> GetAllUnblockedContAdjacentNodesDepthFirst(DavidTiles3D_TileLayer tileLayer, Vector3Int internalPosition, Vector3Int faceNormalLocal, HashSet<Vector3Int> results = null)
        {
            if (results == null)
